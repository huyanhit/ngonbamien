                        ...
                        <ul class="navbar-nav" id="navbar-nav">
                            <li class="nav-item">
                                ...
                                <li class="nav-link menu-link">
                                    <i class="ri-dashboard-2-line"></i>  <a href="{{Request::root().'/admin/products'}}">Sản phẩm</a>
                                </li>
                                <li class="nav-link menu-link">
                                ...
                                <li class="nav-link menu-link" href="#system" data-bs-toggle="collapse" aria-expanded="false"  aria-controls="system">
                                    <i class="ri-dashboard-2-line"></i>
