            ...
            <span class="message-img-link">
                <ul class="list-inline mb-0">
                    <li class="list-inline-item dropdown">
                        <a href="#" role="button" data-bs-toggle="dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="ri-more-fill"></i></a>
                        <div class="dropdown-menu">
                            <a class="dropdown-item cursor-pointer small" @click.prevent.stop="downloadFile(img_id)"><i class="ri-download-2-line me-2 text-muted align-bottom"></i> Download</a>
                        </div>
                    </li>
                </ul>
            </span>
...
import FileService from '@/services/cbox.js'
