            ...
            <div class="ctext-wrap" @mouseenter.prevent.stop="item.reaction = true" @mouseleave.prevent.stop="item.reaction = false">
                ...
                <div class="dropdown align-self-start message-box-drop">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item cursor-pointer" v-if="item.auth !== store.chat.CURRENT_USER.id" @click="reply"><i class="ri-reply-line me-2 mr-2 text-muted align-bottom"></i>{{ $t("chat.chat.reply") }}</a>
                        ...
                        <a class="dropdown-item cursor-pointer" @click="getLink"><i class="ri-link me-2 mr-2 text-muted align-bottom"></i>{{ $t('chat.chat.get_link') }}</a>
                        <a class="dropdown-item cursor-pointer" @click="remove"><i class="ri-delete-bin-5-line me-2 mr-2 text-muted align-bottom"></i>{{ $t('chat.chat.delete') }}</a>
                    </div>
                </div>
            </div>
...
import MessageRender from '@/components/dynamic-partials/MessageRender.vue'
