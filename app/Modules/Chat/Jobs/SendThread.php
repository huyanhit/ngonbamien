...
class SendThread implements ShouldQueue
{
    ...
    public function handle(
        ...
        if($threadId = $this->messageService->addThread($this->data)){
            ...
            $message     = $this->messageService->getChatRepository()->getObject('MESSAGE_IDS', $this->data['thread']);
            ...
            NotificationService::pushNotification('chat_thread_reply', [
                'tos'        => [$message['MESSAGE_IDS'][$this->data['thread']]['auth']],
