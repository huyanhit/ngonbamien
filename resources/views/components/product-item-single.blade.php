...
<div class="featured__item">
    <div class="featured__item__pic">
        ...
        <ul class="featured__item__pic__hover">
            <li><span title="Yêu thích" class="add_favor" data-value="{{$item->id}}"><i class="fa fa-heart mr-1"></i>Yêu thích</span></li>
            <li><span title="Nhắn tin" class="as_message" data-value="{{$item->id}}"><i class="fa fa-comment"></i></span></li>
            <li><span title="Thêm vào giỏ" class="add_cart" data-value="{{$item->id}}"><i class="fa fa-shopping-cart mr-1"></i>Thêm vào giỏ</span></li>
        </ul>
    </div>
