...
<div class="humberger__menu__wrapper">
            ...
            @foreach ($menus as $item)
                @if (empty($item->parent_id))
                    <li class="{{(request()->path() == $item->router)? 'active': ''}}">
                        ...
                        <ul class="header__menu__dropdown ms-2">
    ...
    <div class="header__top__right__social mb-0">
        ...
        <a href="{{ $sites->link_tiktok ?? '#'}}">
            <svg style="height: 15px;" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    ...
                    <nav class="header__menu">
                        <ul class="nav justify-content-center  mt-2">
                            <li class="nav-item px-2">
                                <a class="nav-link text-uppercase font-weight-bold" href="#" data-toggle="tab" data-target="#profile">Giới thiệu</a>
                            </li>
                            <li class="nav-item px-2 active">
                                <a class="nav-link active text-uppercase font-weight-bold" aria-current="page" data-toggle="tab" data-target="#home" href="#">Sản phẩm</a>
                            </li>
                            <li class="nav-item px-2">
                                <a class="nav-link text-uppercase font-weight-bold" href="#" data-toggle="tab" data-target="#contact">Cộng đồng</a>
                            </li>
                            <li class="nav-item px-2">
                                <a class="nav-link text-uppercase font-weight-bold" href="#" tabindex="-1" aria-disabled="true">Liên hệ</a>
                            </li>
                        </ul>
                    </nav>
