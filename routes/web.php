...
Route::post('/ax-subscribe', [HomeController::class, 'subscribe'])->name('ajax-subscribe');
...
Route::get('/cua-hang', [SupplierController::class, 'index'])->name('cua-hang');
Route::get('/cua-hang/{slug}', [SupplierController::class, 'show'])->name('chi-tiet-cua-hang');
...
Route::get('/cong-dong', [SocialController::class, 'index'])->name('cong-dong');
...
Route::get('/{any}', [PageController::class, 'show'])->whereIn('any', ['gioi-thieu', 'tuyen-dung'])->name('xem-trang');
